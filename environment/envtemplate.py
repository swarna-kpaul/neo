...
env = bootstrapenv(objective = "You should take text input from the user. The user may ask question or provide instructions or ask to solve a task. You may need to answer questions, follow instructions and solve tasks based on users input. At the end ask for user feedback.", prioraxioms= "You can use the getanswer function to determine if user input is a question or task or an instruction",shortdescription = "Carry out user commands")
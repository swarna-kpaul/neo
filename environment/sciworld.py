...
class scienv():
    ...
    def update_task(self,task = "1-1"):
        ...
        self.environment = {"description": predescription + objective, "objective": objective, "prior axioms": self.prioraxioms, "belief axioms": "", "current state": self.getstate()}
